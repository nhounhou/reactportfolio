...
function First() {
  return (
    <Wrapper>
      ...
      <section>
        <h3>
          I was born in <strong><a href="https://en.wikipedia.org/wiki/Australia">Australia</a></strong>, my parents are from  <strong><a href="https://en.wikipedia.org/wiki/Laos">Laos</a></strong>. When I was 4, we had to fly away and we arrived in France. Where I was raised for the next 34 years.
        </h3>
        <h3> 
          I got my Associate degree in Computer Science and work as an Analyst-Programmer for 9 years. I was programming in Cobol. I moved to North Carolina in late 2007, and didn't do any programming related work for the next 10 years. I only got back at programming since 2017.
        </h3>
        <h3>
          My hobby are my families, I'm married and have 3 children. I also play <a href="https://www.youtube.com/watch?v=1sPOZlTdB7g" target="_blank">Badminton</a> but since the pandemic start I didn't had a chance to play.
        </h3>
        <br></br>
        <h2>
